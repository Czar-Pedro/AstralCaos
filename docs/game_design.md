...
Última atualização: 14/08/2026 (adicionadas classes, raças, elementos, estrutura de quests)
...
- Confirmar contagem final de classes e raças
- Bônus/penalidades de cada raça (atributos, resistências?)
...
**Elementos de dano** (precisam de tabela de fraqueza/resistência por inimigo — manter enxuto para não explodir o trabalho de balanceamento):
- Físico, Fogo, Água, Ar/Vento, Terra, Raio, Luz, Escuridão *(proposta inicial — 8 elementos, a confirmar)*

**Status/condições** (resiste/imune/vulnerável — não precisa de tabela de dano, então pode ter mais variedade):
- Exemplos: Veneno, Paralisia, Sono, Confusão, Silêncio, Medo *(lista a expandir)*

Inimigos têm **fraquezas e resistências elementais**, e podem ter resistência/imunidade a status específicos.

### Em aberto
- Confirmar lista final de elementos de dano
- Confirmar lista final de status/condições
...
- **Requisito para receber/desbloquear**: condição para a quest ficar disponível para o jogador (técnico — a detalhar quando formos desenhar o model)

### Em aberto
- Como quests principais e de NPC se cruzam
- Sistema de diálogos
- Exemplos concretos de requisitos de desbloqueio (nível? outra quest? item? afinidade com NPC?)
